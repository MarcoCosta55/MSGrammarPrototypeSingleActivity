...
class CheckWork {
    ...
    var errorCount = 0
    var isVerbCorrect = false
    var isAdjectiveCorrect = false

    private lateinit var mediaPlayer: MediaPlayer


    fun checkVerb() {
        isVerbCorrect = symbolPronoun[0] == symbolVerb[0] && symbolPronoun[1] == symbolVerb[1]
    }

    fun checkAdjective(){
        isAdjectiveCorrect = symbolNoun[1] == symbolAdjective[0] && symbolNoun[2] == symbolAdjective[1]
    }

    fun checkSentence() : Int {
